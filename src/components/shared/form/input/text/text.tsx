...
const Text = forwardRef<HTMLInputElement,TextProps>(({ 
  ...
  return (
    <div className={ `${ noBottomMargin? "" : "mb-4" } overflow-visible font-rubik reset-ion-padding transparent-bg` }>
      <div className="w-full">
        <div className="relative w-full">
          ...
          <label 
            ...
            className={`text-surface-onVariant absolute duration-300 transform -translate-y-5 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-darkScheme px-2 peer-focus:px-2  peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-5 left-1 ${ error? "!text-primary-color" : "" }`}>{ translationLabel }</label>
        </div>
        { error && (
          <span
